...
function createStyles(theme: ThemePalette) {
  return StyleSheet.create({
    ...
    txAction: { fontSize: 13.5, fontWeight: '700', color: theme.text },
    txStudentRow: { flexDirection: 'row', alignItems: 'center', gap: 6, flexWrap: 'wrap' },
    txStudentName: { fontSize: 11, fontWeight: '600', color: theme.text },
    txStudentId: { fontSize: 11, color: theme.tertiary },
    facultyBadge: {
      paddingHorizontal: 6,
      paddingVertical: 2,
      borderRadius: 6,
