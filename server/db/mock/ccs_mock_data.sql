...
-- Order: admin → faculty → students (FK-safe, no cross-deps)
-- ─────────────────────────────────────────────────────────────
...
-- 3 named (from original schema dev) + 2 generated
-- ─────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────
-- SECTION 7 · QUEUES
-- Student 101 (Alvin Matthew Ortiz): position 8, 2 completed
-- Student 104 (Luiz Gabriel Rosales): position 11, 1 other active
...
-- Filler entries so queue position math is correct
INSERT INTO queues (queue_id, student_id, service_id, slot_id, queue_number, status, created_at) VALUES
