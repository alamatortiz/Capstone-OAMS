...
-- tracking_number used to be auto-generated by DB triggers here
-- (ts_auto_tracking_number / _faculty). Removed when the project moved off
-- Aiven MySQL to TiDB Cloud Serverless, which doesn't support triggers at
-- all -- tracking numbers are now generated in application code instead
-- (server/utils/trackingNumber.js), and this seed file's own
-- document_requests/faculty_document_requests/document_submissions INSERTs
-- below supply their tracking_number values directly.
...
-- tracking_number assigned explicitly (used to be trigger-generated) --
...
INSERT INTO document_submissions (tracking_number, student_id, department_id, title, purpose, status) VALUES
('SUB-00001', 104, 1001, 'OJT Endorsement Letter', 'For internship requirements', 'claimed');
...
-- document_services row with recipient_type = 'faculty'. Must stay
-- 'FDR-00001' exactly -- referenced by a comment further below.
INSERT INTO faculty_document_requests (tracking_number, faculty_id, service_id, request_type, purpose, status) VALUES
('FDR-00001', 106, 5, 'Certificate of Employment', 'For loan application', 'processing');
