...
-- ============================================================
-- Seed data has been moved to: server/db/mock/ccs_mock_data.sql
-- Run oams_db.sql first (schema + departments), then ccs_mock_data.sql
-- ============================================================

-- Reset tables before seeding (run only in dev/test environments)
...
-- Departments (canonical — not mock data, these are fixed institution records)
