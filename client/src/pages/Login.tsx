    ...
    <div className="login-root">
      ...
      <div className="login-wrapper">
        ...
        <div className="login-logos">
          <img src={pncLogo}  alt="University of Cabuyao" className="login-pnc-logo" />
        ...
        <div className="login-card">
          ...
          <div className="login-card-header">
            ...
            <p className="login-card-desc">Sign in with your @pnc.edu.ph email</p>
            <p className="login-card-hint">Your account type will be automatically detected</p>
          </div>
            ...
            <div className="login-field">
              ...
              <div className="login-input-wrap">
                ...
                <input
                  id="email"
                  type="email"
                  placeholder="your.email@pnc.edu.ph"
                  value={email}
          ...
          <div className="login-demo-box">
            ...
            <ul className="login-demo-list">
              <li><strong>Student:</strong> student@pnc.edu.ph</li>
              <li><strong>Professor:</strong> professor@pnc.edu.ph</li>
              <li><strong>Admin:</strong> admin@pnc.edu.ph</li>
            </ul>
