...
// picked a specific service (the pre-join card-detail view). Once they've
// joined, the queue-status screen shows their picked service's real
// description / requirements / procedure instead.
